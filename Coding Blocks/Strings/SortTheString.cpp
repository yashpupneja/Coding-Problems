...
string extractString(string str,int key){
	//converting the string to character we used c_str()
...
int main() {
	...
	//extract tokens only once and store this seperately
	//making the pair which will store the keys.
